    ...
    <div className=''>
      {
        (loading || success)
        ?
          <Loader message="Hold on creating job..." />
        :
          <></>
      }
      ...
      <div className='px-48 py-5 text-[0.8rem]'>
        ...
        <div className='flex justify-center items-center py-5'>
            <button type='submit' onClick={formik.handleSubmit} className='px-5 py-1.5 bg-[#00756A] rounded-full text-white'>Create Job</button>
        </div>
