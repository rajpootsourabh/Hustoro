...
const DashboardNavbar = ({username}) => {
  ...
  return (
    <div className='w-full bg-black shadow-lg flex justify-center items-center'>
      ...
      <div className='max-w-[1700px] w-full text-white h-20 shadow-lg flex justify-between items-center gap-3 px-32'>
        <div className='flex items-center gap-14'>
          ...
          <ul className='flex item-center gap-0'>
            ...
            <li className={`${path==="employees"?'bg-[#00756A]':''} px-4 py-1.5 rounded-md cursor-pointer font-light`}>Employees</li>
        ...
        <div className='flex gap-5'>
          ...
          {/* avatar */}
          <div className='flex items-center justify-center'>
            <UserMenu loading={loading}  username={username} handleLogout={handleLogout}/>
              {/* <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
